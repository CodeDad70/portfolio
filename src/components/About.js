...
const Contact = ({ style }) => (
  <animated.div className="mainRoute" style={{ ...style, background: `#fff` }}>
    ...
    <a href = "mailto:eric.strickler@gmail.com" > <img className = "email" src={Email} /> </a>
    <a href = "https://github.com/CodeDad70?tab=repositories" target = "blank" ><img  className="github" src={GitHub} /></a>
    <a href = "https://www.linkedin.com/in/eric-strickler/" target = "blank" ><img className="linkedin" src={LinkedIn} /></a>
    </div>
